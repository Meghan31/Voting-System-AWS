...
const Vote22 = () => {
	...
	const handleVote = async (e) => {
		...
		axios
			.post('http://localhost:3001/vote2', { voteTo, ssn, ssnPassword })
			.then((response) => {
	...
	return (
		<div>
			<div className="navbar">
				<h3 className="votehead">You are voting for Kamala Harris</h3>
